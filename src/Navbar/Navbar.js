        ...
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                <a href="/" className="flex items-center">
                    ...
                    <span className="font-2 self-center text-2xl text-gray-500 mt-7">Mir Rashed Photography</span>
                </a>
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
                        ...
                        <li>
                            <a href="/main/allPhotoCategory" className="font-3 text-xl block py-2 pr-4 pl-3 text-gray-400 rounded md:hover:text-gray-700 md:p-0 ">Services</a>
                        </li>
                ...
                <div className="flex items-center">
                    {
                        user?.uid ?
                            <>
                                <Link to="/main/private/myReview">
                                    <button className="mr-5 ml-0 font-3 text-xl block py-2 pr-4 pl-3 text-gray-400 rounded md:hover:text-gray-700 md:p-0">My Reviews</button>
                                </Link>
                                <Link to="/main/private/addServices">
                                    <button className="mr-5 ml-0 font-3 text-xl block py-2 pr-4 pl-3 text-gray-400 rounded md:hover:text-gray-700 md:p-0 ">Add Services</button>
                                </Link>
